...
for data in df.itertuples():
    ...
    out_t = np.load(Path(trial_save, f"{data.trial_string}_cellfree_tc.npy"))[
        :observe_to
    ]
    out_s = np.load(Path(trial_save, f"{data.trial_string}_cellfree_std.npy"))[
        :observe_to
    ]

    all_t = np.load(Path(trial_save, f"{data.trial_string}_full_fov_tc.npy"))[
        :observe_to
    ]
    all_s = np.load(Path(trial_save, f"{data.trial_string}_full_fov_std.npy"))[
        :observe_to
    ]

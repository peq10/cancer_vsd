...
def make_all_grey_vids(top_dir,save_dir,initial_df,viewing_dir,thresh_idx,downsample = 5, redo = False, QCd = False, onlymcf = False):
    ...
    for idx,data in enumerate(df.itertuples()):
        ...
        if Path(viewing_dir, f'{data.trial_string}{namend}.tif').is_file() and not redo and trial_string not in redo_trials:
            continue
        ...
        tifffile.imsave(Path(viewing_dir, f'{data.trial_string}{namend}.tif'),gf.to_8_bit(rat2))
